  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved device as @device" do
        ...
        post :create, {:device => { "token" => "invalid value" }}, valid_session
        expect(assigns(:device)).to be_a_new(Device)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested device" do
        ...
        expect_any_instance_of(Device).to receive(:update).with({ "token" => "MyString" })
        put :update, {:id => device.to_param, :device => { "token" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the device as @device" do
        ...
        put :update, {:id => device.to_param, :device => { "token" => "invalid value" }}, valid_session
        expect(assigns(:device)).to eq(device)
      end
